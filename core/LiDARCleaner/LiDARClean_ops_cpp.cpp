...
void occ_dtc(
    ...
    occ_dtc_cuda(epp1, epp2, pts2dsrch_v1_batch, pts2d_v1_batch, pts2d_v2_batch, srh_distance, occ_selector, minsr_dist, minoc_dist, bz, h, w);
    return;
}

PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("occ_dtc", &occ_dtc, "occlusion detection");
}
